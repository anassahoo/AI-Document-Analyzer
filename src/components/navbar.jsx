  ...
  return (
    <div>
      <nav className='flex items-center p-4 bg-white dark:bg-slate-900 shadow-md border-b border-gray-200 dark:border-gray-700 transition-colors'>
        ...
        <h1 className='ml-auto mr-auto text-2xl font-semibold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent'>Welcome To Dashboard</h1>
